...
export type Asset = "BTC" | "ETH" | "SOL" | "XRP" | "BNB" | "AVAX";
...
export const ASSET_META: Record<Asset, { name: string; options: boolean }> = {
  ...
  SOL: { name: "Solana", options: false },
  XRP: { name: "XRP", options: false },
  BNB: { name: "BNB", options: false },
  AVAX: { name: "Avalanche", options: false },
};
